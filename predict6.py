...
# 执行批量裁剪
input_folder = r"E:\code\unet-pytorch-main\test4\img"
crop_output_folder = r"E:\code\unet-pytorch-main\test4\img_crop_out"
...
if __name__ == "__main__":
    ...
    # 指定待预测图片所在文件夹路径
    dir_origin_path = r"E:\code\unet-pytorch-main\test4\img_crop_out"
    
    # 指定保存预测结果的文件夹路径
    dir_save_path = r"E:\code\unet-pytorch-main\test4\img_predict_out"
    ...
    stitched_output_folder = r"E:\code\unet-pytorch-main\test4\img_predict_stitch"
