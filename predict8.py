...
# 执行批量裁剪
input_folder = r"D:\test7\img"
crop_output_folder = r"D:\test7\img_crop_out"
...
if __name__ == "__main__":
    ...
    # 指定待预测图片所在文件夹路径
    dir_origin_path = r"D:\test7\img_crop_out"
    
    # 指定保存预测结果的文件夹路径
    dir_save_path = r"D:\test7\img_predict_out"
    ...
    # 执行拼接
    original_folder = r"D:\test7\img" #存放原始文件的地方，注意不是裁剪后的预测文件
    stitched_output_folder = r"D:\test7\img_predict_stitch"
