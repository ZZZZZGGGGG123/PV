...
crop_output_folder = r"E:\code\unet-pytorch-main\test\img_out2"
...
if __name__ == "__main__":
    ...
    # 指定待预测图片所在文件夹路径
    dir_origin_path = r"E:\code\unet-pytorch-main\test\img_out2"
    
    # 指定保存预测结果的文件夹路径
    dir_save_path = r"E:\code\unet-pytorch-main\test\img_prdict_out3"
